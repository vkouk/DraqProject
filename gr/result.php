...
<div class="row risk-info">
    <p>Σε περίπτωση που βρεθείτε σε μια απο τις ζώνες υψηλού κινδύνου 3, 4, ή 5,
        <strong>θα πρέπει να επικοινωνήσετε</strong> άμεσα με τον προσωπικό σας ιατρό ή
        να μεταβείτε στο κοντινότερο διαβητολογικό κέντρο νοσοκομείου, προκειμένου να κάνετε
        <strong>μια</strong> από τις ακόλουθες αιματολογικές εξετάσεις:</p>
    <ul>
        <li>Δοκιμασία ανοχής σακχάρου (Καμπύλη ζακχάρου) με 75γρ. γλυκόζης.</li>
        <li>Σακχάρου νηστείας</li>
    </ul>
