...
<head>
    ...
    <!--26/2/2017-Updated this link so that it will take our css changes.-->
...
<body>
	...
	<footer class="footer">
	    <div class="container">
	    	<div class="row">
	    		<div class="col-xs-4">
                                   <!--26/2/2017-Same applies for links for any  other media that is stored in separate folder.-->
